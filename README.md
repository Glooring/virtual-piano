...
1. **Download the Project Archive**  
   Download the latest release from the [Releases](https://github.com/Glooring/virtual-piano/releases) page or directly using [this link](https://github.com/user-attachments/files/17362623/virtual-piano-v1.0.zip), which includes the `release` folder containing `main.exe` and all necessary internal dependencies.
